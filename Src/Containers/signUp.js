        ...
        <Container style={{ backgroundColor: '#F6F6F6' }}>
            <Content>
                ...
                <View style={{ marginLeft: 20, marginRight: 20, marginTop: 10 }}>
                    ...
                    <TouchableOpacity style={{width:184,height:41,backgroundColor:'#8D7EE2',justifyContent:'center',alignItems:'center',alignSelf:'center',marginTop:25,borderRadius:5}} onPress={()=>navigation.navigate('varifyCode')}>
